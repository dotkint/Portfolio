...
const certifications = [
  {
    imgSrc: `${import.meta.env.BASE_URL}images/intern-cert.jpg`,
    description: "Bicol University - University Regustrar Office Intern"
  },
  {
    imgSrc: `${import.meta.env.BASE_URL}images/bootcamp.jpg`,
    description: "Basic Web Development Workshop"
  },
  {
    imgSrc: `${import.meta.env.BASE_URL}images/microsoft-office.jpg`,
    description: "Microsoft Office Specialist: Excel Associate Certification Training Program"
  },
  {
    imgSrc: `${import.meta.env.BASE_URL}images/dictV-webinar.jpg`,
