...
const socialLinks = [
  {
    href: 'https://github.com/thatiskint',
  ...
  {
    href: 'https://www.linkedin.com/in/kntdlpn',
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    href: 'https://www.facebook.com/notdump.knt',
    icon: 
    <svg 
    ...
    >
        ...
        1.326 24h11.495v-9.294H9.691V11.07h3.13V8.414c0-3.1 1.894-4.788 
        4.659-4.788 1.325 0 2.463.099 
        2.794.143v3.24h-1.918c-1.504 
        0-1.797.716-1.797 1.766v2.316h3.587l-.467 
        3.636h-3.12V24h6.116C23.403 24 
  ...
  {
    href: 'https://www.instagram.com/thatkint',
    ...
    return (
        <section
            ...
            <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
                ...
                <form
                action="https://getform.io/f/aroglmyb"
                method="POST"
                className="xl:pl-10 2xl:pl-20">
                    ...
                    <div className="mb-4">
                        ...
                        placeholder="Hi! I have a project to be done and I am interested to have collaboration with you.">
                        </textarea>
                    </div>
